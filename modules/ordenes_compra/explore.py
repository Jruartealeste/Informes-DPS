...
de .env, navega DIRECTO por URL a "Orden Compra Produccion" (seccion
"Ordenes de Compra" > "O.C. Produccion") y exporta a Excel.
...
Uso:
    python -m modules.ordenes_compra.explore
"""
import os
import sys
...
def main():
    ...
    with sync_playwright() as p:
        ...
        print("Login OK. Navegando directo a Orden Compra Produccion...")
        base_url = URL.split("Login.aspx")[0]
        direct_url = f"{base_url}Default.aspx#ViewID=OrdenCompraProduccion_ListView&ObjectClassName=DPS_SAS_SR.Module.OrdenCompraProduccion"
        ...
        try:
            ...
            destino = OUT_DIR / "orden_compra_produccion_export.xlsx"
