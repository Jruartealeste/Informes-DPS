"""
Exporta el listado de "OCs Pendientes de Generar" desde Advertys: login +
...
Uso:
    python -m modules.oc_pendientes_generar.export
"""
import sys
...
DIRECT_URL_SUFFIX = "Default.aspx#ViewID=EstimadoDetalle_ListView_OC_Pendientes&ObjectClassName=DPS_SAS_SR.Module.EstimadoDetalle"
    ...
    with sync_playwright() as p:
        ...
        try:
            try:
                ...
                page.screenshot(path=str(SCREENSHOT_DIR / "oc_pendientes_generar_export_error_login.png"))
                raise
            ...
            try:
                ...
                page.screenshot(path=str(SCREENSHOT_DIR / "oc_pendientes_generar_export_error_download.png"), full_page=True)
                raise ExportError(f"Error exportando OCs Pendientes de Generar: {e}") from e
