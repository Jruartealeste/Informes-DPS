...
def main():
    ...
    with sync_playwright() as p:
        ...
        if "Login.aspx" in page.url:
            ...
            page.screenshot(path=str(SCREENSHOT_DIR / "estimados_error_login.png"))
            browser.close()
            sys.exit(1)
        ...
        page.screenshot(path=str(SCREENSHOT_DIR / "estimados_01_listado.png"), full_page=True)
        ...
        page.wait_for_timeout(500)
        page.screenshot(path=str(SCREENSHOT_DIR / "estimados_02_filtro_todos.png"), full_page=True)
        ...
        try:
            ...
            page.screenshot(path=str(SCREENSHOT_DIR / "estimados_error_export.png"), full_page=True)
